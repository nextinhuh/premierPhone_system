...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Registrar novo cliente</h4>
                <br>
                @if ($errors->any())
                ...
                <div class="alert alert-success"><b>Ótimo!</b> Cliente cadastrado com sucesso!</div>
                @endif
                ...
                <div class="alert alert-danger"><b>Ops!</b> Algo deu errado, já existe um cliente com esse CPF,
                ...
                @endif
                <form action="{{route('save_register')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="form-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" data-toggle="tooltip" data-placement="top"
                                                ...
                                                placeholder="Marca" id="brand" name="cpf">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" data-toggle="tooltip" data-placement="top"
                                                title="Informe a marca do produto" class="form-control"
                                                placeholder="Marca" id="brand" name="rg">
                                        </div>
                                    </div>
                    ...
                    <div class="form-actions">
                        <div class="text-right">
                            <button type="submit" class="btn btn-info">Cadastrar cliente</button>
                        </div>
                    </div>
                </form>
            </div>
